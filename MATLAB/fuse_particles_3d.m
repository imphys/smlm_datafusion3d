...
function [output_coordinates_x, output_coordinates_y, output_coordinates_z, output_transformation_parameters]...
    = fuse_particles_3d(...
        n_particles,...
        ...
        symmetry_order,...
        outlier_threshold,...
        output_coordinates_x,...
        output_coordinates_y,...
        output_coordinates_z,...
...
output_coordinates_x(1:end) = transformed_coordinates(:,1);
output_coordinates_y(1:end) = transformed_coordinates(:,2);
output_coordinates_z(1:end) = transformed_coordinates(:,3);
output_transformation_parameters(1:end) = transformation_parameters;
