...
% function [curweight, S] = delParticle(Particles, fusedParticles, idx, weight)
% % function [curweight, S] = delParticle(Particles, fusedParticles, idx)
function [S] = delParticle(Particles, fusedParticles, idx, weight)
...
%    curweight(particlesSize+1:curParticleSize,:) = [];
